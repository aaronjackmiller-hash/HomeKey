...
exports.createListing = async (req, res) => {
    try {
        ...
        const listing = new RoommateListing({
            ...
            utilities: {
                electricity: parsePositiveNumber(utilities?.electricity) ?? 0,
                water: parsePositiveNumber(utilities?.water) ?? 0,
                internet: parsePositiveNumber(utilities?.internet) ?? 0,
                vaad: parsePositiveNumber(utilities?.vaad) ?? 0,
            },
