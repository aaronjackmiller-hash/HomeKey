...
// ── Amenity SVG icons — identical to FilterMenu.js and Step3Amenities.js ─────
const AMENITY_ICONS = {
...
const AMENITY_OPTIONS = [
  { value: 'mamad',                label: 'Mamad',           icon: 'shield' },
        ...
        <div className="roommate-amenities-grid">
          {AMENITY_OPTIONS.map((amenity) => {
            ...
            return (
              ...
              >
                <RwAmenityIcon name={amenity.icon} />
